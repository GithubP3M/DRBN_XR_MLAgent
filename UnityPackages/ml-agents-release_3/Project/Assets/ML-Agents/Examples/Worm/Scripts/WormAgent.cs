...
public class WormAgent : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        bpDict[bodySegment1].SetJointTargetRotation(continuousActionOut[++i], continuousActionOut[++i], 0);
        bpDict[bodySegment2].SetJointTargetRotation(continuousActionOut[++i], continuousActionOut[++i], 0);
        bpDict[bodySegment3].SetJointTargetRotation(continuousActionOut[++i], continuousActionOut[++i], 0);

        // Update joint strength
        bpDict[bodySegment1].SetJointStrength(continuousActionOut[++i]);
        bpDict[bodySegment2].SetJointStrength(continuousActionOut[++i]);
        bpDict[bodySegment3].SetJointStrength(continuousActionOut[++i]);
